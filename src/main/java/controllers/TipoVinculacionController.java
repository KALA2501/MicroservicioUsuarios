...
import services.TipoVinculacionService;
...
public class TipoVinculacionController {
    ...
    @Operation(
        summary = "Obtener todos los tipos de vinculación",
        description = "Retorna una lista de todos los tipos de vinculación registrados en el sistema"
    )
