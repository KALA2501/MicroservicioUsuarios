...
public class ComentarioController {
    ...
    @Operation(
        ...
        description = "Retorna una lista de todos los comentarios almacenados en el sistema"
    )
    ...
    @Operation(
        summary = "Guardar un comentario",
        description = "Recibe un objeto comentario en el cuerpo de la solicitud y lo almacena en el sistema"
    )
