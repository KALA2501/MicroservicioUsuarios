...
public class TipoDocumentoController {
    ...
    @Operation(summary = "Obtener todos los tipos de documento", description = "Retorna una lista de todos los tipos de documento registrados en el sistema")
    ...
    @Operation(summary = "Obtener tipo de documento por ID", description = "Retorna un tipo de documento según su identificador")
    ...
    public ResponseEntity<?> obtenerPorId(@PathVariable String id) {
        ...
        return tipo.isPresent() ? ResponseEntity.ok(tipo.get())
                : ResponseEntity.status(HttpStatus.NOT_FOUND).body("Tipo de documento no encontrado");
    }

    @Operation(summary = "Crear un tipo de documento", description = "Crea y guarda un nuevo tipo de documento")
    ...
    public ResponseEntity<?> guardar(@RequestBody TipoDocumento tipoDocumento) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body("Error al crear tipo de documento: " + e.getMessage());
        }
    }

    @Operation(summary = "Eliminar un tipo de documento", description = "Elimina un tipo de documento por ID")
