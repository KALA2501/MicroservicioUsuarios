...
public class CentroMedicoController {
    ...
    @Operation(summary = "Obtener todos los centros médicos", description = "Retorna una lista de todos los centros médicos registrados en el sistema")
    ...
    @Operation(summary = "Obtener centro médico por ID", description = "Retorna un centro médico a partir del identificador proporcionado")
    ...
    @Operation(summary = "Crear un centro médico", description = "Guarda un centro médico recibido en el cuerpo de la petición")
    ...
    public ResponseEntity<?> guardar(@RequestBody CentroMedico centroMedico) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body("Error al guardar centro médico: " + e.getMessage());
        }
    }

    @Operation(summary = "Eliminar un centro médico", description = "Elimina el centro médico identificado por el ID proporcionado")
    ...
    @Operation(summary = "Actualizar información de un centro médico", description = "Permite editar el nombre, dirección, teléfono y logo del centro médico")
    ...
    public ResponseEntity<?> actualizar(@PathVariable Long id, @RequestBody CentroMedico nuevosDatos) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body("Error al actualizar centro médico: " + e.getMessage());
        }
    }
